<template>
  ...
  <img class="mx-auto my-4 w-64" src="@/assets/Logo2.jpeg"/>
    ...
    <p>
      ...
      del cliente, brindando alta calidad y servicios en el suministro de
      energías renovables.
    </p>
  <h2 class="text-center text-2xl font-bold mt-8 mb-4">Fundadores</h2>
	<ul class="space-y-4">
		<li class="flex-column sm:flex gap-4 p-4 rounded-lg border-2 border-gray-200 cursor-pointer transition hover:shadow-md">
			<img class="object-cover w-44 h-44 rounded-full m-auto" src="@/assets/brian.jpeg"/>
		...
		<li class="flex-column sm:flex gap-4 p-4 rounded-lg border-2 border-gray-200 cursor-pointer transition hover:shadow-md">
			<img class="object-cover w-44 h-44 rounded-full m-auto" src="@/assets/bryan.jpeg"/>
			<div class="flex-1 my-auto space-y-2">
